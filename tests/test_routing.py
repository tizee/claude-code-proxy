...
from server import determine_model_by_router, Config, CUSTOM_OPENAI_MODELS, create_message
...
class TestRoutingLogic(unittest.TestCase):
    ...
    def setUp(self):
        ...
        patcher_models = patch.dict('server.CUSTOM_OPENAI_MODELS', self.mock_models, clear=True)
    ...
    def test_determine_model_by_router_default_fallback(self):
        ...
        routed_model = determine_model_by_router(
            original_model="some-other-model",
            token_count=100,
            has_thinking=False
        )
        self.assertEqual(routed_model, "model-default")
    ...
    def test_long_context_fallback_when_tokens_exceed_limit(self, mock_create_message):
        ...
        preliminary_model = "model-with-low-limit" # This model has max_input_tokens: 500
    ...
    @patch('server.create_message')
    def test_long_context_fallback_when_tokens_are_within_limit(self, mock_create_message):
        """
